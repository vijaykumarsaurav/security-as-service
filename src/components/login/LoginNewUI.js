    ...
    <Container component="main" xs sm maxWidth="sm">
      ...
      <div className={classes.paper}>
        ...
        <form className={classes.form} noValidate>
          ...
          <InputLabel htmlFor="Front" required={true}>SIM Reference Number | හැදුනුම්පත්  අංකය ඇතුලත් කරන්න | தேசிய அடையாள அட்டை எண்ணை உள்ளிடவும்</InputLabel>            <br />
           ...
           <TextField
             ...
             //   label="Enter your NIC number | හැදුනුම්පත්  අංකය ඇතුලත් කරන්න | உங்கள் என்.ஐ.சி. எண்ணை உள்ளிடவும்"
                ...
                onChange={handleNic}
                disabled={props.loginProps.disableSimRef}
                value={props.loginProps.simRefNumber}
              />

          <InputLabel htmlFor="Front" required={true}>Enter your Alternate Number | දුරකථන අංකය ඇතුලත් කරන්න | உங்களுடைய தொலைபேசி எண்ணை உள்ளிடவும்(7XXXXXXXX)</InputLabel>            <br />
         ...
         <> 
          <InputLabel htmlFor="Front" required={true}>Enter OTP received via SMS | කෙටි පණිවුඩයක් හරහා ලැබුණු OTP අංකය ඇතුළත් කරන්න | SMS  வழியாக பெறப்பட்ட OTP எண்ணை உள்ளிடவும்</InputLabel>            <br />
         ...
         <TextField
                ...
                fullWidth
                name="otpCode"
               // label="Enter OTP received via SMS | කෙටි පණිවුඩයක් හරහා ලැබුණු OTP අංකය ඇතුළත් කරන්න | SMS  வழியாக பெறப்பட்ட OTP எண்ணை உள்ளிடவும்"
                type="password"
                id="otpCode"
                autoComplete="current-otpCode"
                onChange={handleOtp}
                value={props.loginProps.otpCode}
              />
          ...
          >
           ...
           {props.loginProps.actionText === "Login" ? Parser("Next <br /> ඉදිරියට <br />அடுத்து")   : Parser('Request for OTP <br />OTP සඳහා ඉල්ලීම<br /> OTP க்கான  கோரிக்கை')}
...
//   render() {
//     return <input name="alternateNum" onChange = {this.props.handler}/ >
//   }
// }
